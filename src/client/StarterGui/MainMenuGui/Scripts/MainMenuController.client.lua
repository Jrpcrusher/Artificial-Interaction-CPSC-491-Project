...
local yesBtn = warningFrame:WaitforWaitForChild("ButtonRow"):WaitForChild("YesButton", 5)
local noBtn = warningFrame:WaitforWaitForChild("ButtonRow"):WaitForChild("NoButton", 5)
